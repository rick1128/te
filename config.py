...
OWNER_ID = getenv("OWNER_ID", "5582470474")
...
SUDO_USERS = list(map(int, getenv("SUDO_USERS", "5582470474").split()))
COMMAND_PREFIXES = list(getenv("COMMAND_PREFIXES", "").split())
ALIVE_IMG = getenv("ALIVE_IMG", "https://telegra.ph/file/3d4e9709614892e62a969.jpg")
START_PIC = getenv("START_PIC", "https://telegra.ph/file/3d4e9709614892e62a969.jpg")
